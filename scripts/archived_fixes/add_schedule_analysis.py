...
# Добавим метод schedule_analysis после create_analysis
new_method = """
    def schedule_analysis(self, project_id: str, analysis_name: str, 
        ...
        if not scheduled_time:
            scheduled_time = datetime.now() + timedelta(minutes=5)  # По умолчанию через 5 минут
...
# Вставляем после create_analysis  
...
print("✅ Метод schedule_analysis добавлен!")
