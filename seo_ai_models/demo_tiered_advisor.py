...
def parse_arguments():
    ...
    parser.add_argument("--keywords", type=str, help="Ключевые слова для анализа (через запятую)")

    parser.add_argument("--api-key", type=str, help="API ключ для LLM-сервиса")

    parser.add_argument("--beta", action="store_true", help="Активировать бета-функции")
