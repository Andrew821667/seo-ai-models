...
from seo_ai_models.models.tiered_system.scheduling.analysis_scheduler import AnalysisScheduler, AnalysisTask, TaskPriority
from seo_ai_models.models.tiered_system.scheduling.cost_optimization_advisor import CostOptimizationAdvisor
...
class TieredSystemIntegrationTests(unittest.TestCase):
    ...
    def test_full_analysis_workflow(self):
        ...
        self.assertLess(analysis_credits, 1000, "Баланс кредитов ANALYSIS должен уменьшиться после использования")
    ...
    def test_credit_budget_interaction(self):
        ...
        for credit_type in CreditType:
            ...
            planner_balance = self.budget_planner.budget_plan["available_credits"].get(credit_type.value, 0)
    ...
    def test_scheduler_credit_integration(self):
        ...
        if initial_credits > 0:
            ...
            self.assertLess(after_credits, initial_credits, "Кредиты должны уменьшаться при использовании")
        else:
