...
class AdaptiveParsingPipeline:
    ...
    def detect_site_type(self, url: str) -> Dict[str, Any]:
        ...
        if error or not html_content:
            ...
            if error or not html_content:
                ...
                return {"is_spa": False, "confidence": 0.0, "error": error}
    ...
    def analyze_url(self, url: str, detect_type: bool = True) -> Dict[str, Any]:
        ...
        """
        result = {"url": url, "success": False, "content": None, "metadata": None, "error": None}
    ...
    def crawl_site(
        self, base_url: str, detect_type: bool = True, **crawler_options
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if is_spa:
                ...
                spa_options = {
                    ...
                    "wait_for_timeout": crawler_options.get(
                        "wait_for_timeout", self.wait_for_timeout
                    ),
