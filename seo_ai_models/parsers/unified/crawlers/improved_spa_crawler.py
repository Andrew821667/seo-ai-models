...
class ImprovedSPACrawler:
            ...
            try:
                ...
                while urls_to_visit and len(self.crawled_urls) < self.max_pages:
                    ...
                    try:
                        ...
                        if self.bypass_protection:
                            await page.add_init_script(self.fingerprint_generator.get_browser_fingerprint_script())
    ...
    async def _handle_response(self, response: Response):
        ...
        try:
            ...
            if self.enable_graphql and url in self.intercepted_requests and url.endswith("/graphql") or "graphql" in url:
                try:
