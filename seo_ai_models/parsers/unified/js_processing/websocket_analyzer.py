...
class WebSocketAnalyzer:
    ...
    def capture_message(
        self,
        message_data: Union[str, Dict, List],
        direction: str = "incoming",
        endpoint: Optional[str] = None,
        ...
        try:
            ...
            message = WebSocketMessage(content=parsed_data, direction=direction, endpoint=endpoint)
    ...
    def _extract_by_pattern(
        self, content: Any, pattern: WebSocketPattern
