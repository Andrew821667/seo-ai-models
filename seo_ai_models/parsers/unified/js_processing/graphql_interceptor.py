...
class GraphQLInterceptor:
    ...
    def intercept_request(
        self, url: str, headers: Dict[str, str], body: Union[str, Dict, List]
        ...
        try:
            ...
            for op_data in operations_data:
                ...
                operation = GraphQLOperation(
                    query=query, variables=variables, operation_name=operation_name, endpoint=url
                )
                    ...
                    result.append(
                        {
                            ...
                            "operation": (
                                response.operation.to_dict() if response.operation else None
                            ),
