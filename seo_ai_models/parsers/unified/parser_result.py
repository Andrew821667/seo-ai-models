...
class PageStructure:
    ...
    links: Dict[str, List[Dict[str, str]]] = field(default_factory=lambda: {"internal": [], "external": []})
...
class ParserResult:
    ...
    @classmethod
    def create_page_result(cls, page_data: PageData, processing_time: float = 0.0) -> 'ParserResult':
        """
    ...
    @classmethod
    def create_site_result(cls, site_data: SiteData, processing_time: float = 0.0) -> 'ParserResult':
        """
    ...
    @classmethod
    def create_search_result(cls, search_data: SearchResultData, processing_time: float = 0.0) -> 'ParserResult':
        """
