...
class SPADetector:
    ...
    def __init__(self):
        ...
        self.framework_patterns = {
            ...
            "Ember": [
                # Признаки Ember
                'ember-application', 'data-ember', 'ember-view', 'ember-controller',
            ...
            "SvelteKit": [
                # Признаки SvelteKit
                '__SVELTEKIT', 'svelte-', 'svelte.js', 'svelte.min.js'
            ]
        }
        ...
        self.dynamic_loading_indicators = [
            'lazyload', 'lazy-load', 'infinite-scroll', 'infinite-loading',
            'load-more', 'loadMore', 'pagination'
        ]
