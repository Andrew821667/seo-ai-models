"""
Компоненты для микро-бизнеса в многоуровневой системе SEO анализа.

Пакет предоставляет легковесные компоненты для микро-бизнеса
в рамках многоуровневой системы SEO анализа.
"""
