...
class CostOptimizationAdvisor:
    ...
    def _recommend_plan(
        ...
        efficiency_diff = self.PLAN_EFFICIENCY[recommended_tier] - self.PLAN_EFFICIENCY[current_tier]
    ...
    def _estimate_savings(
        ...
        coefficients = self.strategy_coefficients.get(self.strategy, {'cost': 0.5, 'performance': 0.5})
        ...
        return {
            ...
            'overall_score': round(
                coefficients['cost'] * cost_percent + coefficients['performance'] * efficiency_impact * 100,
                2
            ),
        }
