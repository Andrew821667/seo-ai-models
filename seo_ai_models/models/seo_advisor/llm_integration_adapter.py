...
class LLMAdvisorFactory:
    ...
    def create_compatibility_analyzer(self) -> Optional[LLMCompatibilityAnalyzer]:
        ...
        try:
            return LLMCompatibilityAnalyzer(
                self.services["llm_service"], self.services["prompt_generator"]
            )
        except Exception as e:
    ...
    def create_citability_scorer(self) -> Optional[CitabilityScorer]:
        ...
        try:
            return CitabilityScorer(self.services["llm_service"], self.services["prompt_generator"])
        except Exception as e:
    ...
    def create_llm_eeat_analyzer(self) -> Optional[LLMEEATAnalyzer]:
        ...
        try:
            return LLMEEATAnalyzer(self.services["llm_service"], self.services["prompt_generator"])
        except Exception as e:
...
class LLMEnhancedSEOAdvisor(SEOAdvisor):
    ...
    def enhance_content(
        self, content: str, enhancement_type: str = "structure", llm_budget: Optional[float] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _perform_llm_analysis(
        self, content: str, llm_budget: Optional[float] = None, **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            eeat_result = self.llm_eeat_analyzer.analyze_eeat(content, budget=component_budget)
            ...
            result["llm_metrics"] = {
                "overall_compatibility": compatibility_result.get("compatibility_scores", {}).get(
                    "overall", 0
                ),
