...
class TutorialGenerator:
    ...
    def experience_level_mapping(self) -> List[str]:
        ...
        if self.experience_level == "beginner":
            ...
            return [
                TutorialLevel.BEGINNER.value,
                TutorialLevel.INTERMEDIATE.value,
                TutorialLevel.ADVANCED.value,
            ]
        else:
            return [TutorialLevel.BEGINNER.value]
    ...
    def generate_topic_tutorial(self, topic_id: str) -> Dict[str, Any]:
        ...
        if not topic:
            return {"status": "error", "message": f"Топик {topic_id} не найден"}
    ...
    def generate_personalized_tutorial(self) -> Dict[str, Any]:
        ...
        return {
            "status": "success",
            "user_info": {"plan": self.plan, "experience_level": self.experience_level},
            "recommended_path": {
    ...
    def generate_quick_start_guide(self) -> Dict[str, Any]:
        ...
        for topic_id in basic_topics:
            ...
            if topic:
                ...
                beginner_materials = [
                    m for m in topic["materials"] if m["level"] == TutorialLevel.BEGINNER.value
                ]
    ...
    def generate_feature_tutorial(self, feature_id: str) -> Dict[str, Any]:
        ...
        if feature_id not in feature_to_topic:
            return {"status": "error", "message": f"Функция {feature_id} не найдена"}
        ...
        if not topic:
            return {"status": "error", "message": f"Топик для функции {feature_id} не найден"}
