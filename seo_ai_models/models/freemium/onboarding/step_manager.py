...
class StepManager:
    ...
    def _load_steps_config(
        self, steps_config: Optional[Union[Dict[str, Any], str]]
    ) -> Dict[str, Any]:
        """
    ...
    def check_step_availability(self, step_id: str, completed_steps: List[str]) -> Dict[str, Any]:
        ...
        return {"available": True, "message": f"Шаг {step_id} доступен", "missing_dependencies": []}

    def get_next_step(
        self, current_step_id: str, completed_steps: List[str]
    ...
    def customize_steps(self, customizations: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "disabled_steps" in customizations:
            ...
            self.steps_config["steps"] = [
                step
                for step in self.steps_config["steps"]
                if step["id"] not in disabled_steps or step["required"]
            ]
    ...
    def save_steps_config(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Ошибка сохранения конфигурации: {str(e)}"}
    ...
    def load_steps_config_from_file(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Ошибка загрузки конфигурации: {str(e)}"}
