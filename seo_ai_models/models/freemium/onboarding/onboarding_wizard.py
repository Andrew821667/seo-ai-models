...
class OnboardingWizard:
    ...
    def __init__(
        self, user_id: str, plan: Optional[str] = "free", config: Optional[Dict[str, Any]] = None
    ):
        """
    ...
    def _get_step_content(self, step: str) -> Dict[str, Any]:
        ...
        step_contents = {
            ...
            OnboardingStep.ACCOUNT_SETUP.value: {
                ...
                "form": {
                    "fields": [
                        {"name": "full_name", "type": "text", "label": "ФИО", "required": True},
                        {"name": "company", "type": "text", "label": "Компания", "required": False},
                        {
                            "name": "industry",
                            "type": "select",
                            "label": "Отрасль",
                        ...
                        },
                        {
                            ...
                            "options": ["Новичок", "Средний уровень", "Эксперт"],
                            "required": True,
                        },
                    ],
            ...
            OnboardingStep.PROJECT_CREATION.value: {
                ...
                "action": {"type": "form_submit", "next_step": OnboardingStep.FIRST_ANALYSIS.value},
            },
            OnboardingStep.FIRST_ANALYSIS.value: {
                ...
                "demo": {"type": "interactive", "url": "/demo/first-analysis"},
                "tips": [
            ...
            OnboardingStep.EXPLORE_FEATURES.value: {
                ...
                "action": {
                    ...
                    "next_step": (
                        ...
                        if OnboardingStep.INVITE_TEAM.value in self.progress["next_steps"]
                        else OnboardingStep.COMPLETE.value
                    ),
                },
            },
            OnboardingStep.INVITE_TEAM.value: {
                ...
                "form": {
                    "fields": [
                        ...
                        },
                        {
                            ...
                            "type": "select",
                            "label": "Роль",
                            "options": ["Администратор", "Редактор", "Аналитик", "Наблюдатель"],
                            "required": True,
                        },
                    ],
    ...
    def advance_to_step(self, step: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Неизвестный шаг: {step}"}
    ...
    def _process_account_setup(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field in required_fields:
            if field not in data or not data[field]:
                return {"status": "error", "message": f"Поле {field} обязательно для заполнения"}
    ...
    def _process_project_creation(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not website_url.startswith(("http://", "https://")):
            return {"status": "error", "message": "URL должен начинаться с http:// или https://"}
