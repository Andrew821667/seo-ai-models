...
class UpgradePath:
    ...
    UPGRADE_PATHS = {
        FreemiumPlan.FREE: [FreemiumPlan.MICRO, FreemiumPlan.BASIC, FreemiumPlan.PROFESSIONAL, FreemiumPlan.ENTERPRISE],
        FreemiumPlan.MICRO: [FreemiumPlan.BASIC, FreemiumPlan.PROFESSIONAL, FreemiumPlan.ENTERPRISE],
    ...
    def complete_upgrade(self, target_plan: Union[str, FreemiumPlan]) -> Dict[str, Any]:
        ...
        initiated_upgrades = [
            upgrade for upgrade in self.upgrade_history
    ...
    def cancel_upgrade(self, target_plan: Union[str, FreemiumPlan]) -> Dict[str, Any]:
        ...
        return {
            "status": "success",
            "message": f"Upgrade to {target_plan.value} cancelled"
        }
