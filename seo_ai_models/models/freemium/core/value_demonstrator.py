...
class ValueDemonstrator:
    ...
    def __init__(
        ...
        """
        self.current_plan = current_plan if isinstance(current_plan, FreemiumPlan) else FreemiumPlan(current_plan)
    ...
    def demonstrate_feature(self, feature_name: str) -> Dict[str, Any]:
        ...
        available_in_plans = [
            plan.value for plan in feature_info
        ...
        if not available_in_current_plan:
            for plan in [FreemiumPlan.MICRO, FreemiumPlan.BASIC, FreemiumPlan.PROFESSIONAL, FreemiumPlan.ENTERPRISE]:
        ...
        return {
            ...
            "available_in_plan": available_in_plans[0] if available_in_plans else None,  # Для совместимости с тестами
    ...
    def get_comparison_table(self) -> Dict[str, Any]:
        ...
        """
        plans = [FreemiumPlan.FREE, FreemiumPlan.MICRO, FreemiumPlan.BASIC, FreemiumPlan.PROFESSIONAL, FreemiumPlan.ENTERPRISE]
        
        # Создаем таблицу сравнения
        table = {
            "headers": ["Feature"] + [plan.value for plan in plans],
            "rows": []
        }
    ...
    def get_roi_calculator(self, plan: Union[str, FreemiumPlan]) -> Dict[str, Any]:
        ...
        if plan not in roi_data:
            return {
                "status": "error",
                "message": f"ROI data for plan {plan.value} not found"
            }
    ...
    def get_available_features(self, plan: Optional[Union[str, FreemiumPlan]] = None) -> Dict[str, bool]:
        """
