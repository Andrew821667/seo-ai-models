...
projects_total = Gauge("projects_total", "Total number of projects", ["status"], registry=REGISTRY)

tasks_total = Gauge("tasks_total", "Total number of tasks", ["status"], registry=REGISTRY)

webhooks_total = Gauge("webhooks_total", "Total number of webhooks", ["status"], registry=REGISTRY)

webhook_triggers_total = Counter(
    "webhook_triggers_total", "Total webhook triggers", ["status"], registry=REGISTRY
)

# Error metrics
errors_total = Counter("errors_total", "Total errors", ["type", "endpoint"], registry=REGISTRY)
