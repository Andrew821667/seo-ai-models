...
class MetricsConsistencyChecker:
    ...
    def __init__(self):
        ...
        self.rules = [
            ...
            {
                "condition": lambda m: m.get("avg_sentence_length", 0) > 25
                and m.get("readability", 0) > 0.7,
            ...
            {
                "condition": lambda m: m.get("word_count", 0) > 800
                and not m.get("has_images", False)
                and m.get("multimedia_score", 0) > 0.4,
